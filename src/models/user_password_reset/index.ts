...
import IEntities, { IUserEmailChangeEntities, IUserReferEntities, IUserResponsiveEntities } from "./entities";
...
export class UserResponsivesModel extends autoImplementWithBase(Model)<IUserResponsiveEntities>() {
  public created_at: string;
  public updated_at: string;
  static get tableName() {
    return "user_responsive";
  }
